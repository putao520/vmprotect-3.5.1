...
TEST(CoreTest, UTF8Validator)
{
	...
	ASSERT_TRUE(os::ValidateUTF8(os::ToUTF8(os::unicode_string(L"抗我把我抖抖我扯忘"))));
	ASSERT_FALSE(os::ValidateUTF8(std::string("抗我把我抖抖我扯忘 1251")));
}
TEST(CoreTest, FromACP)
{
	ASSERT_TRUE(os::FromACP(std::string("抗我把我抖抖我扯忘 1251")) == os::unicode_string(L"抗我把我抖抖我扯忘 1251"));
}
#endif